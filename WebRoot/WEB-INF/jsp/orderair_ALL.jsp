		...
		<script>
					$(document).ready(function() {
						$('#example').DataTable({
							...
							"ajax": "../json_save/orderairlist_all.json",
							"bInfo" : false,
		          ...
		          "bSort" : true,//设置自动排序的地方,true表示排序，false表示取消自动排序
			            ...
			            "sSearch" : "搜索" 
							...
							"fnCreatedRow": function (nRow, aData, iDataIndex) {
								/*
								var URL = "../servlet/AirInfoDeleteServlet";
								...
								$('td:eq(6)', nRow).html("<a href='../servlet/AirInfoChaKanServlet?chakan="+chakan+"'>查看</a>"
						  								+"/<a href='../servlet/AirInfoModifyUIServlet?xiugai="+xiugai+"'>修改</a>"
								  	+"/<a href=javascript:void(0) onclick=if(window.confirm('是否确定删除？'))this.href='"+URL+"?shanchu="+shanchu+"'>删除</a>");
								*/
								$('td:eq(8)', nRow).html("");
							}
						});
