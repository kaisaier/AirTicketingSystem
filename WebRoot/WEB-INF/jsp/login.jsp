							...
							<form
								...
								<div id="login-box"
									...
									<div class="toolbar clearfix">
										<h3 class="center"
											style="color: #fff; line-height: 55px; margin: 0 auto;">登
											录</h3>
										<!-- 										  	<div>
										...
										<div class="widget-main">
											...
											<form>
												<fieldset>
													...
													<div class="space"></div>
													<div class="clearfix">
														<label class="inline col-sm-6"> <input
															type="radio" value="1" name="level" class="ace" /> <span
															class="lbl"> 管理员 </span>
														</label> <label class="inline col-sm-6"> <input
															type="radio" value="0" name="level" class="ace" /> <span
															class="lbl"> 用户</span>
														</label>
													</div>
													...
													<div class="clearfix">
														<button type="submit"
															class="btn btn-sm btn-primary col-sm-5">
															<i class="ace-icon fa fa-key"></i> <span
																class="bigger-110">登录</span>
														</button>
														<a
															href="${pageContext.request.contextPath}/servlet/RegisterUIServlet"
															class="btn btn-sm btn-primary pull-right col-sm-5 btn-info">
