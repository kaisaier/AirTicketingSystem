...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/assets/css/color.css">
<!--[if lte IE 9]>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/assets/js/color.js"></script>
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-right" role="navigation">
				...
				<li><a href="../">回到首页</a> </li>
					...
					<li class="light-blue"
						style="width: 70px; border: 0; cursor: pointer;"
						onclick="window.open('../servlet/LoginOutUIServlet','_self');">
			...
			<ul class="nav nav-list">
				<li class="active open"><a href="#" class="dropdown-toggle">
						<i class="menu-icon fa fa-tag"></i> <span class="menu-text">
							航班信息 </span> <b class="arrow fa fa-angle-down"></b>
				</a> <b class="arrow"></b>

					<ul class="submenu">
						<li class=""><a href="../servlet/MainUIServlet"> <i
								class="menu-icon fa fa-caret-right"></i> 航班列表
						</a> <b class="arrow"></b></li>
						<li class=""><a href="../servlet/OrderAirAllUIServlet"> <i
								class="menu-icon fa fa-caret-right"></i> 订票列表
						</a> <b class="arrow"></b></li>
						<li class=""><a href="../servlet/AddNewAirInfoUIServlet">
								<i class="menu-icon fa fa-caret-right"></i> 增加航班
						</a> <b class="arrow"></b></li>
					</ul></li>

				<li class="active open"><a href="#" class="dropdown-toggle">
						<i class="menu-icon fa fa-tag"></i> <span class="menu-text">
							用户信息 </span> <b class="arrow fa fa-angle-down"></b>
				</a> <b class="arrow"></b>

					<ul class="submenu">
						<li class=""><a href="../servlet/UserDataUIListServlet">
								<i class="menu-icon fa fa-caret-right"></i> 用户列表
						</a> <b class="arrow"></b></li>
						<li class=""><a href="../servlet/UserDataAddUIServlet"> <i
								class="menu-icon fa fa-caret-right"></i> 添加用户
						</a> <b class="arrow"></b></li>
					</ul></li>

				<li class="active open"><a href="#" class="dropdown-toggle">
						<i class="menu-icon fa fa-calendar"></i> <span class="menu-text">
							个人中心 </span> <b class="arrow fa fa-angle-down"></b>
				</a> <b class="arrow"></b>
					<ul class="submenu">
						<li class=""><a href="../servlet/PersonDataUIservlet"> <i
