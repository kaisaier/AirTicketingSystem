			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					<div class="page-content" style="padding-top: 50px;">
								<form class="col-sm-7 col-sm-offset-2 form-horizontal" action="${pageContext.request.contextPath }/servlet/UserDataAddServlet" method="post">
												<fieldset>
													<div class="form-group">
														<label for="uid" class="col-sm-2 control-label no-padding-right">用户编号(即手机号)</label>
														<div class="col-sm-7">
															<span class="block input-icon input-icon-right">
																<input type="text" name="uidtel" value="${formBean.uidtel}" class="form-control" placeholder="请输入用户号(即手机号)" /><span class="red">${formBean.errors.uidtel}${errorMsg}</span>
													...
													<div class="form-group">
														...
														<div class="col-sm-7">
														<span class="block input-icon input-icon-right">
															<input type="text" name="name" value="${formBean.name}" class="form-control" placeholder="请输入姓名" /><span class="red">${formBean.errors.name}</span>
															<i class="ace-icon fa fa-user"></i>
														</span>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-7">
														<span class="block input-icon input-icon-right">
															<input type="password" name="password" class="form-control" placeholder="请输入密码" /><span class="red">${formBean.errors.password}</span>
													...
													<div class="form-group">
														...
														<div class="col-sm-7">
															<label for="vill" class="col-sm-2.5 control-label no-padding-right">管理者</label> <input type="radio" name="level" class="ace" value="1" ${formBean.level==1?'checked':''}><span class="lbl"></span>&nbsp;&nbsp;
															<label for="vill" class="col-sm-2.5 control-label no-padding-right">普通用户</label> <input type="radio" name="level" class="ace" value="0" ${formBean.level==0?'checked':''}><span class="lbl"></span>
													...
													<div class="clearfix">
														...
														<div class="col-sm-7">
															<button type="submit" class="btn btn-big btn-success form-control">
