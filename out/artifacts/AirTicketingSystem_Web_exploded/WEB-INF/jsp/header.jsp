				...
				<ul class="nav nav-list">
					<li class="active open">
						...
						<ul class="submenu">
							...
							<li class="">
									<a href="../servlet/OrderAirAllUIServlet">
									<i class="menu-icon fa fa-caret-right"></i>
									订票列表 
								</a>
							...
							<li class="">
									<a href="../servlet/AddNewAirInfoUIServlet">
									<i class="menu-icon fa fa-caret-right"></i>
									增加航班
								</a>
					...
					<li class="active open">
						...
						<ul class="submenu">
							<li class="">
								<a href="../servlet/UserDataUIListServlet">
									<i class="menu-icon fa fa-caret-right"></i>
									用户列表
								</a>
							...
							<li class="">
								<a href="../servlet/UserDataAddUIServlet">
									<i class="menu-icon fa fa-caret-right"></i>
									添加用户
								</a>
