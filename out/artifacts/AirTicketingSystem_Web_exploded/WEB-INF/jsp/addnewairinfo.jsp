			...
			<div class="main-content">
				...
				<c:choose>
			   	<c:when test="${requestScope.airInfoAddHuixian==null }">
					...
					<form class="form-horizontal" role="form" action=${pageContext.request.contextPath}/servlet/AddNewAirInfoServlet method=post>
						...
						<div class="form-group">
							<label for="using" class="col-sm-3 control-label no-padding-right">目的地:</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<div class="col-md-offset-5 col-md-7">
								<input class="btn btn-info" type="submit" value="添加该航班" name="airInfo_add">
							</div>
						</div>
					</form>
			   	...
			   	<c:otherwise>
					...
					<form class="form-horizontal" role="form" action=${pageContext.request.contextPath}/servlet/AddNewBookServlet method=post>
						<div class="form-group">
							<label for="fnum" class="col-sm-3 control-label no-padding-right">图书编号:</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.bookAddHuixian.bid} name="bid" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<label for="tnum" class="col-sm-3 control-label no-padding-right">图书名称:</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.bookAddHuixian.bookname} name="bookname" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<label for="using" class="col-sm-3 control-label no-padding-right">图书作者:</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.bookAddHuixian.writer} name="writer" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<label for="user" class="col-sm-3 control-label no-padding-right">图书出版社:</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.bookAddHuixian.publication} name="publication" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-offset-5 col-md-7">
								<input class="btn btn-info" type="submit" value="添加该图书" name="book_add">
							</div>
						</div>
					</form>
