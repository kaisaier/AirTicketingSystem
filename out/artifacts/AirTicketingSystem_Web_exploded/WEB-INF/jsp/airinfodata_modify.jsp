...
<%@ include file="header.jsp"%>
			<div class="main-content">
				...
				<div class="main-content-inner">
					...
					<form class="form-horizontal" role="form" action=${pageContext.request.contextPath}/servlet/AirInfoModifyServlet method=post>
						<div class="form-group">
							<label for="name" class="col-sm-3 control-label no-padding-right">航班编号 </label>
							<div class="col-sm-9">
								<input type="text" readonly value=${requestScope.airInfoHuixian.airid}  name="airid" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<label for="fnum" class="col-sm-3 control-label no-padding-right">出发地</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.airInfoHuixian.startplace} name="startplace" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<label for="tnum" class="col-sm-3 control-label no-padding-right">目的地</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.airInfoHuixian.endplace} name="endplace" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<label for="using" class="col-sm-3 control-label no-padding-right">起飞时间</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.airInfoHuixian.datatime} name="datatime" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<label for="using" class="col-sm-3 control-label no-padding-right">票价</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.airInfoHuixian.price} name="price" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
							<label for="using" class="col-sm-3 control-label no-padding-right">余票</label>
							<div class="col-sm-9">
								<input type="text" value=${requestScope.airInfoHuixian.ticketnum} name="ticketnum" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<!-- 
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-md-offset-5 col-md-7">
								<input class="btn btn-info" type="submit" value="提交修改" name="airInfo_update">
							</div>
						</div>
					</form>
