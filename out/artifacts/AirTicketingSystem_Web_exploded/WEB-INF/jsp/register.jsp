								...
								<div id="signup-box" class="signup-box visible widget-box no-border">
									<div class="widget-body">
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="uidtel" value="${formBean.uidtel}" class="form-control" placeholder="请输入手机号" />${formBean.errors.uidtel}${errorMsg}
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="name" value="${formBean.name}" class="form-control" placeholder="请输入姓名" />${formBean.errors.name}
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" name="password" class="form-control" placeholder="请输入密码" />${formBean.errors.password}
													...
													<div class="clearfix">
														<label class="col-sm-4 hidden">
															<input type="radio" value="0" name="level" class="ace" checked/>
										...
										<div class="toolbar center">
											<a href="${pageContext.request.contextPath}/servlet/LoginUIServlet" data-target="#login-box" class="back-to-login-link">
