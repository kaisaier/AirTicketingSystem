   	...
   	<c:otherwise>
   		<%@ include file="header_WS.jsp"%>
			...
			<div class="main-content">
				...
				<form class="form-horizontal" role="form" action=${pageContext.request.contextPath}/servlet/AirInfoFuKuanServlet method=post>
					<div class="tableBigDiv">
						<table id="example" class="display" cellspacing="0" style="width: 90%">
							<thead>
								<tr>
					...
					<div class="form-group hidden">
							...
							<div class="col-sm-9">
								<input type="text" readonly value=${requestScope.airid}  name="airid" class="col-xs-10 col-sm-5">
							</div>
						</div>
					<div class="space-4"></div>
					<div class="clearfix">
						<label class="inline col-sm-6"> 
							<input type="radio" value="1" name="fukuanway" class="ace" />
							<span class="lbl"> 支付宝/微信 </span>
						</label>
						<label class="inline col-sm-6"> 
							<input type="radio" value="0" name="fukuanway" class="ace" />
							<span class="lbl"> 只是预定,暂不付款  </span>
						</label>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
							<div class="col-md-offset-5 col-md-7">
								<input class="btn btn-info" type="submit" value="提交选项" name="tijiaofukuan">
							</div>
						</div>
				</form>
				</div>
...
<![endif]-->
		...
		<script>
			$(document).ready(function() {
				$('#example').DataTable({
					"ajax": "../json_save/airinfo_order.json",
					"iDisplayLength" : 40,
					"bPaginate" : false,
					"bFilter" : false,
					"bInfo" : false,
