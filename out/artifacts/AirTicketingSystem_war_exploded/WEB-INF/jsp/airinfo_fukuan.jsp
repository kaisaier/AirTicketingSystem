	...
	<div class="main-content-inner">
		<div class="page-content">
			<div class="page-header">
				<h1 class="text-center green">航班付款界面</h1>
			</div>
			<form class="form-horizontal" role="form"
				action=${pageContext.request.contextPath}/servlet/AirInfoFuKuanServlet
				method=post>
				...
				<div class="form-group hidden">
					...
					<div class="col-sm-9">
						<input type="text" readonly value=${requestScope.airid
							}  name="airid" class="col-xs-10 col-sm-5">
					</div>
				</div>
				<div class="space-4"></div>
				<div class="clearfix">
					<label class="inline col-sm-6"> <input type="radio"
						value="1" name="fukuanway" class="ace" /> <span class="lbl">
							支付宝/微信 </span>
					</label> <label class="inline col-sm-6"> <input type="radio"
						value="0" name="fukuanway" class="ace" /> <span class="lbl">
							只是预定,暂不付款 </span>
					</label>
				</div>
				<div class="space-4"></div>
				<div class="form-group">
					<div class="col-md-offset-5 col-md-7">
						<input class="btn btn-info" type="submit" value="提交选项"
							name="tijiaofukuan">
					</div>
				</div>
			</form>
